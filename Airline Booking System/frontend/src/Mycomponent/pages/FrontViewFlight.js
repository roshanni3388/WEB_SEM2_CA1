...
function FrontViewFlights() {
    ...
    const HendleClick=(id)=>{
       alert("If You Wants View Details of flight You Should Login")
       navigate("/login")
     }
    ...
    const handleFilter = (e) => {
     ...
     const handleSubmit = async (id) => {
        ...
        alert("If You Wants Book flight You Should Login")
        navigate("/login")
      }
    ...
    export default FrontViewFlights
